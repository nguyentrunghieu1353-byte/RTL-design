...
HA hatang1_t3 (.a(p23), .b(p32), .Sum(s3), .Cout(c3));
HA hatang1_t4 (.a(p33), .b(p42), .Sum(s4), .Cout(c4));
HA hatang1_t5 (.a(p43), .b(p52), .Sum(s5), .Cout(c5));

HA hatang2 (.a(s1), .b(p30 ), .Cout(c6), .Sum(s6) ) ; 
HA hatang2_t1 (.a(s2), .b(c1),  .Sum(s7), .Cout(c7));
HA hatang2_t2 (.a(s3), .b(c2),  .Sum(s8), .Cout(c8));
HA hatang2_t3 (.a(s4), .b(c3),  .Sum(s9), .Cout(c9));
HA hatang2_t4 (.a(s5), .b(c4),  .Sum(s10), .Cout(c10));
...
FA fatang3_t5 (.a(s10), .b(c9), .Cin(c16), .Sum(z[7]), .Cout(c17));

endmodule 
// iverilog -0 simv ArrayMultiplier4x4.v
//vvp simv